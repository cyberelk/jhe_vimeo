...
/**
 * Test case for class Tx_Jhe_vimeo_Controller_VideoController.
 *
 * @version $Id$
 ...
 */
class Tx_Jhe_vimeo_Controller_VideoControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
