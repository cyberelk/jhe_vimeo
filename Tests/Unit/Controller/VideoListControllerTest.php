...
/**
 * Test case for class Tx_Jhe_vimeo_Controller_VideoListController.
 *
 * @version $Id$
 ...
 */
class Tx_Jhe_vimeo_Controller_VideoListControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
